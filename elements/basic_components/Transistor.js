...
Transistor.prototype.updateConnections = function() {
    this.inputsFrom = [];
    this.outputsTo = [];
...
Transistor.prototype.updateSource = function() {
    ...
    this.active = this.hasSource && this.hasGround;
};

Transistor.prototype.updateGround = function() {
    this.updateConnections();
    this.hasSource = false;
...
Switch.prototype.propagateSource = function() {
    this.updateSource();
...
Switch.prototype.propagateGround = function() {
    this.updateGround();
